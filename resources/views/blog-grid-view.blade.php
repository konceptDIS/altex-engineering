...
<head>
    ...
    <title>Blog Grid View &ndash; Industrey HTML Template</title>
    <meta name="robots" content="noindex, follow">
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="favicons/5792-images-fevicon.png">
...
<body>
    ...
    <div class="page-wrapper">
							  ...
							  <div class="pbmit-header-info-inner">
								 ...
								 <div class="pbmit-header-box pbmit-header-box-2">
									<a href="#"> 
										...
										<span class="pbmit-header-box-content"><span class="__cf_email__" data-cfemail="cea7a0aabbbdbabcabb7a7a0a8a18ea9a3afa7a2e0ada1a3">[email&nbsp;protected]</span></span>
									</a> 
								 </div>
													...
													<ul class="navigation clearfix">
														...
														<li class="dropdown active">
															...
															<ul>
																...
																<li class="active"><a href="blog-grid-view.html">Blog  Grid view</a></li>
		...
		<!-- Title Bar End-->
         ...
         <div class="page-content">   
            ...
            <!-- Blog Grid -->
            <section class="blog-grid section-lg">
				<div class="container">
					<div class="row">
						...
						<div class="col-md-6 col-xl-4">
							<article class="pbmit-blog-style-1">
								<div class="post-item">
									<div class="pbmit-featured-container">
										<div class="pbmit-featured-wrapper">
											<img src="images/blog-blog-new-03.jpg" class="img-fluid" alt="">
										</div>
										<div class="pbmit-meta-date-wrapper">
											<span>18 Jun 2021</span>
										</div>
						...
						<div class="col-md-6 col-xl-4">
							<article class="pbmit-blog-style-1">
								<div class="post-item">
									<div class="pbmit-featured-container">
										<div class="pbmit-featured-wrapper">
											<img src="images/blog-blog-new-04.jpg" class="img-fluid" alt="">
										</div>
										<div class="pbmit-meta-date-wrapper">
											<span>29 Jun 2021</span>
										</div>
									...
									<div class="pbminfotech-box-content">
										...
										<h3 class="pbmit-post-title">
											<a href="blog-single-details.html">OUR ENGINEERS PROVIDE GUIDANCE FOR OIL AND GAS INDUSTRY WORKERS</a>
										</h3>
										<div class="pbminfotech-box-desc">Consectetur adipiscing elit sed do tempor labor dolore magna&hellip;</div>
									</div>
								</div>
						...
						<div class="col-md-6 col-xl-4">
							<article class="pbmit-blog-style-1">
								<div class="post-item">
									<div class="pbmit-featured-container">
										<div class="pbmit-featured-wrapper">
											<img src="images/blog-blog-new-05.jpg" class="img-fluid" alt="">
										</div>
										<div class="pbmit-meta-date-wrapper">
											<span>18 Jun 2021</span>
										</div>
									...
									<div class="pbminfotech-box-content">
										...
										<h3 class="pbmit-post-title">
											<a href="blog-single-details.html">WE ARE BEST FOR A ANY INDUSTRIAL &amp; CONSTRUCTION RELATED SOLUTION</a>
										</h3>
										<div class="pbminfotech-box-desc">Consectetur adipiscing elit sed do tempor labor dolore magna&hellip;</div>
									</div>
								</div>
						...
						<div class="col-md-6 col-xl-4">
							<article class="pbmit-blog-style-1">
								<div class="post-item">
									<div class="pbmit-featured-container">
										<div class="pbmit-featured-wrapper">
											<img src="images/blog-blog-new-06.jpg" class="img-fluid" alt="">
										</div>
										<div class="pbmit-meta-date-wrapper">
											<span>18 Jun 2021</span>
										</div>
									...
									<div class="pbminfotech-box-content">
										...
										<h3 class="pbmit-post-title">
											<a href="blog-single-details.html">WE ARE ACHIEVING SUCCESS BY OUR STANDARD PRODUCTION &amp; SOLUTIONS</a>
										</h3>
										<div class="pbminfotech-box-desc">Consectetur adipiscing elit sed do tempor labor dolore magna&hellip;</div>
									</div>
								</div>
						...
						<div class="col-md-6 col-xl-4">
							<article class="pbmit-blog-style-1">
								<div class="post-item">
									<div class="pbmit-featured-container">
										<div class="pbmit-featured-wrapper">
											<img src="images/blog-blog-new-07.jpg" class="img-fluid" alt="">
										</div>
										<div class="pbmit-meta-date-wrapper">
											<span>29 Jun 2021</span>
										</div>
									...
									<div class="pbminfotech-box-content">
										...
										<h3 class="pbmit-post-title">
											<a href="blog-single-details.html">WE ARE MASTER IN MANUFACTURING &amp; DESIGNING INDUSTRIAL PRODUCTS</a>
										</h3>
										<div class="pbminfotech-box-desc">Consectetur adipiscing elit sed do tempor labor dolore magna&hellip;</div>
									</div>
								</div>
						...
						<div class="col-md-6 col-xl-4">
							<article class="pbmit-blog-style-1">
								<div class="post-item">
									<div class="pbmit-featured-container">
										<div class="pbmit-featured-wrapper">
											<img src="images/blog-blog-new-08.jpg" class="img-fluid" alt="">
										</div>
										<div class="pbmit-meta-date-wrapper">
											<span>18 Jun 2021</span>
										</div>
									...
									<div class="pbminfotech-box-content">
										...
										<h3 class="pbmit-post-title">
											<a href="blog-single-details.html">HIGH CONSTRUCTION TRAINING AND SAFETY PROVIDE BY OUR ENGINEERS</a>
										</h3>
										<div class="pbminfotech-box-desc">Consectetur adipiscing elit sed do tempor labor dolore magna&hellip;</div>
									</div>
								</div>
						...
						<div class="col-md-6 col-xl-4">
							<article class="pbmit-blog-style-1">
								<div class="post-item">
									<div class="pbmit-featured-container">
										<div class="pbmit-featured-wrapper">
											<img src="images/blog-blog-new-09.jpg" class="img-fluid" alt="">
										</div>
										<div class="pbmit-meta-date-wrapper">
											<span>18 Jun 2021</span>
										</div>
									...
									<div class="pbminfotech-box-content">
										...
										<h3 class="pbmit-post-title">
											<a href="blog-single-details.html">WE HAVE HARD WORKING WELDERS AND THEIR MANUFACTURING SUPERB</a>
										</h3>
										<div class="pbminfotech-box-desc">Consectetur adipiscing elit sed do tempor labor dolore magna&hellip;</div>
									</div>
								</div>
						...
						<div class="pbmit-footer-overlay-right col-xl-9 col-md-12">
							...
							<div class="pbmit-footer-contact-info">
								<div class="pbmit-footer-contact-info-inner d-flex align-items-center">
									...
									<div class="pbmit-footer-contact-info-wrap">
										<span class="pbmit-label pbmit-label-2">E-mail Address</span><a href="email-protection.html" class="__cf_email__" data-cfemail="3c555258494f484e594555525a537c5b515d5550125f5351">[email&nbsp;protected]</a>
									</div>
								</div>
							</div>
							<div class="pbmit-footer-contact-info">
	...
	<!-- Search Box End Here -->
     ...
     <!-- JS
         ============================================ -->
      <!-- jQuery JS -->
      <script data-cfasync="false" src="js/cloudflare-static-email-decode.min.js"></script><script src="js/1648-js-jquery.min.js"></script>
      <!-- Popper JS -->
      <script src="js/2824-js-popper.min.js"></script>
      <!-- Bootstrap JS -->
      <script src="js/6683-js-bootstrap.min.js"></script> 
      <!-- jquery Waypoints JS -->
      <script src="js/6965-js-jquery.waypoints.min.js"></script>
      <!-- jquery Appear JS -->
      <script src="js/4845-js-jquery.appear.js"></script>
      <!-- Numinate JS -->
      <script src="js/6557-js-numinate.min.js"></script>
      <!-- Swiper JS -->
      <script src="js/1808-js-swiper.min.js"></script>
      <!-- Magnific JS -->
      <script src="js/3100-js-jquery.magnific-popup.min.js"></script>
      <!-- Circle Progress JS -->
      <script src="js/6221-js-circle-progress.js"></script>  
      <!-- Scripts JS -->
      <script src="js/5048-js-scripts.js"></script>       

<script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'897494014b17a3bc',t:'MTcxODk3ODk4NS4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
</html>
