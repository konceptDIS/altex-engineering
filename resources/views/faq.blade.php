...
<html class="no-js" lang="en">
   <head>
      ...
      <title>FAQ &ndash; Industrey HTML Template</title>
      <meta name="robots" content="noindex, follow">
      <meta name="description" content="">
      <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
      <!-- Favicon -->
      <link rel="shortcut icon" type="image/x-icon" href="favicons/2794-images-fevicon.png">
      <!-- CSS
         ============================================ -->
      <!-- Bootstrap CSS -->
   ...
   <body>
							  ...
							  <div class="pbmit-header-info-inner">
								 ...
								 <div class="pbmit-header-box pbmit-header-box-2">
									<a href="#"> 
										...
										<span class="pbmit-header-box-content"><span class="__cf_email__" data-cfemail="4a23242e3f393e382f3323242c250a2d272b232664292527">[email&nbsp;protected]</span></span>
									</a> 
								 </div>
		...
		<div class="page-content">
            ...
            <section class="section-xxl">
				<div class="container">
					<div class="pbmit-heading-subheading text-center">
						<h4 class="pbmit-subtitle">COMMON QUESTIONS</h4>
						<h2 class="pbmit-title">Frequently Asked Questions</h2>
						<p class="mt-4">You will find answers to about our various industries and industry specialists service and more. Please feel free to <br> contact us if you don't get your question's answer in below.</p>
					</div>
					<div class="row">
						<div class="col-md-6">
							<div class="accordion accordion-style-2" id="accordionExample">
								<div class="accordion-item active">
									<h2 class="accordion-header" id="headingOne">
										...
										01. CAN I BE INVOLVED WITH THE DESIGN BUILD PROCESS?
										</button>
									</h2>
									<div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
										<div class="accordion-body">
											There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don&rsquo;t look even slightly believable.
										</div>
									</div>
								</div>
								<div class="accordion-item">
									<h2 class="accordion-header" id="headingTwo">
										<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
										 03. WHAT IS THE FUTURE OF OIL AND GAS INDUSTRY?
										</button>
									</h2>
								...
								<div class="accordion-item">
									<h2 class="accordion-header" id="headingThree">
										...
										05. HOW DOES THE MANUFACTURING INDUSTRY WORK?
										</button>
									</h2> 
								...
								<div class="accordion-item">
									<h2 class="accordion-header" id="headingfour">
										<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapsefour" aria-expanded="false" aria-controls="collapsefour">
										 07. WHAT KIND OF SOUNDS DO WIND TURBINES PRODUCE?
										</button>
									</h2>
								...
								<div class="accordion-item">
									<h2 class="accordion-header" id="headingfive">
										...
										09. WHAT IS YOUR MINIMUM ORDER QUANTITY FOR PROCESSING?
										</button>
									</h2> 
						...
						<div class="col-md-6">
							<div class="accordion accordion-style-2" id="accordionExample1">
								<div class="accordion-item active">
									<h2 class="accordion-header" id="heading1">
										<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse1" aria-expanded="false" aria-controls="collapse1">
										02. CAN I BE INVOLVED WITH THE DESIGN BUILD PROCESS?
										</button>
									</h2>
								...
								<div class="accordion-item">
									<h2 class="accordion-header" id="heading2">
										...
										04. WHAT IS THE FUTURE OF OIL AND GAS INDUSTRY?
										</button>
									</h2> 
								...
								<div class="accordion-item">
									<h2 class="accordion-header" id="heading3">
										...
										06. HOW DOES THE MANUFACTURING INDUSTRY WORK?
										</button>
									</h2> 
								...
								<div class="accordion-item">
									<h2 class="accordion-header" id="heading4">
										...
										08. WHAT KIND OF SOUNDS DO WIND TURBINES PRODUCE?
										</button>
									</h2> 
								...
								<div class="accordion-item">
									<h2 class="accordion-header" id="heading5">
										...
										10. WHAT IS YOUR MINIMUM ORDER QUANTITY FOR PROCESSING?
										</button>
									</h2> 
            ...
            <section class="section-xxl pbmit-bg-color-light">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<div class="pbmit-heading-subheading text-center text-light">
								<h4 class="pbmit-subtitle">GENERAL QUERIES</h4>
								<h2 class="pbmit-title">Frequently Asked Questions</h2>
								<p class="mt-4 text-black">You will find answers to about our various industries and industry specialists service and more. Please feel free to <br>  contact us if you don't get your question's answer in below.</p>
							</div>
						</div>
					</div>
					<div class="row">
								...
								<div class="accordion-item active">
									<h2 class="accordion-header" id="headingOne1">
										<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne1" aria-expanded="false" aria-controls="collapseOne1">
											01. WHERE CAN I GET A GRANT TO DEVELOP MY WIND POWER INVENTION?
										</button>
									</h2>
									<div id="collapseOne1" class="accordion-collapse collapse show" aria-labelledby="headingTwo1" data-bs-parent="#accordionExample2">
										<div class="accordion-body">
											There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don&rsquo;t look even slightly believable.
										</div>
									</div>
								...
								<div class="accordion-item">
									<h2 class="accordion-header" id="headingTwo1">
										<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo1" aria-expanded="false" aria-controls="collapseTwo1">
											02. HOW IS OUR CONSTRUCTION&rsquo;S PROCESS DIFFERENT FROM OTHERS IN THE INDUSTRY?
										</button>
									</h2>
									<div id="collapseTwo1" class="accordion-collapse collapse" aria-labelledby="headingTwo1" data-bs-parent="#accordionExample2">
										<div class="accordion-body">
											There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don&rsquo;t look even slightly believable.
										</div>
									</div>
								...
								<div class="accordion-item">
									<h2 class="accordion-header" id="headingThree1">
										<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree1" aria-expanded="false" aria-controls="collapseThree1">
											03. CLASSIFY YOUR MANUFACTURE INDUSTRY. HOW YOU ARE DIFFERENT FROM OTHER?
										</button>
									</h2>
								...
								<div class="accordion-item">
									<h2 class="accordion-header" id="headingFour1">
										<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour1" aria-expanded="false" aria-controls="collapseFour1">
											04. IS THERE A LIST OF CHEMICALS OR MATERIALS THAT YOU DO NOT BLEND OR HANDLE?
										</button>
									</h2>
									<div id="collapseFour1" class="accordion-collapse collapse" aria-labelledby="headingFour1" data-bs-parent="#accordionExample2">
										<div class="accordion-body">
											There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don&rsquo;t look even slightly believable.
										</div>
									</div>
								...
								<div class="accordion-item">
									<h2 class="accordion-header" id="headingFive1">
										<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive1" aria-expanded="false" aria-controls="collapseFive1">
											05. HOW MAY I CONTACT REPRESENTATIVES OF THE OIL AND GAS PRODUCTION INDUSTRY?
										</button>
									</h2>
									<div id="collapseFive1" class="accordion-collapse collapse" aria-labelledby="headingFive1" data-bs-parent="#accordionExample2">
										<div class="accordion-body">
											There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don&rsquo;t look even slightly believable.
										</div>
									</div>
						...
						<div class="pbmit-footer-overlay-right col-xl-9 col-md-12">
							...
							<div class="pbmit-footer-contact-info">
								<div class="pbmit-footer-contact-info-inner d-flex align-items-center">
									...
									<div class="pbmit-footer-contact-info-wrap">
										<span class="pbmit-label pbmit-label-2">E-mail Address</span><a href="email-protection.html" class="__cf_email__" data-cfemail="a1c8cfc5d4d2d5d3c4d8c8cfc7cee1c6ccc0c8cd8fc2cecc">[email&nbsp;protected]</a>
									</div>
								</div>
							</div>
							<div class="pbmit-footer-contact-info">
	...
	<!-- Search Box End Here -->
     ...
     <!-- JS
         ============================================ -->
      <!-- jQuery JS -->
      <script data-cfasync="false" src="js/cloudflare-static-email-decode.min.js"></script><script src="js/327-js-jquery.min.js"></script>
      <!-- Popper JS -->
      <script src="js/5145-js-popper.min.js"></script>
      <!-- Bootstrap JS -->
      <script src="js/1946-js-bootstrap.min.js"></script> 
      <!-- jquery Waypoints JS -->
      <script src="js/4818-js-jquery.waypoints.min.js"></script>
      <!-- jquery Appear JS -->
      <script src="js/6525-js-jquery.appear.js"></script>
      <!-- Numinate JS -->
      <script src="js/9480-js-numinate.min.js"></script>
      <!-- Swiper JS -->
      <script src="js/4602-js-swiper.min.js"></script>
      <!-- Magnific JS -->
      <script src="js/7577-js-jquery.magnific-popup.min.js"></script>
      <!-- Circle Progress JS -->
      <script src="js/8698-js-circle-progress.js"></script>  
      <!-- Scripts JS -->
      <script src="js/3125-js-scripts.js"></script>   
	  
   <script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'897493755cc495e1',t:'MTcxODk3ODk2Mi4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
</html>
