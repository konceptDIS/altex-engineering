            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 service-left-col order-2 order-lg-1">
                        @php
                            $sidebar = 'Civil Engineering';
                        @endphp
                        @include('services.side-menu', ['sidebar' => $sidebar])
                    </div>
                    <div class="col-lg-9 service-right-col order-1">
                        <div class="pbmit-service-single">
                            <img src="images/bg-2.png" class="img-fluid w-100" alt="">
                        </div>
                        <div class="service-details">
                            <div class="pbmit-service-contant">
                                <h3 class="pbmit-title">Description of service</h3>
                                <p>
                                    We offer civil and structural construction services to clients in the private and public institutions. Our services cover the design and construction of small, medium and large-scale projects ranging from office and business complexes, residential estates, and parks.
                                </p>
                                <p>
                                    Our team of experienced civil and building engineers are adept at designs, engineering, procurement, and commissioning projects across public and private sectors. We offer the following services:
                                </p>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <ul class="list-group list-group-borderless">
                                            <li class="list-group-item">Road Construction</li>
                                            <li class="list-group-item">Hydraulic Structures</li>
                                            <li class="list-group-item">Road maintenance and development</li>
                                        </ul>
                                    </div>
                                    <div class="col-md-6">
                                        <ul class="list-group list-group-borderless">
                                            <li class="list-group-item">Drainage construction</li>
                                            <li class="list-group-item">Bridges</li>
                                            <li class="list-group-item">Landscaping</li>
                                        </ul>
                                    </div>
                                    <div class="col-md-6">
                                        <img src="images/aerial-shot.jpg" class="img-fluid img-grid" alt="">
                                    </div>
                                    <div class="col-md-6">
