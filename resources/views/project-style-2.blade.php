...
<head>
    ...
    <title>Project Style 2 &ndash; Industrey HTML Template</title>
    <meta name="robots" content="noindex, follow">
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="favicons/2011-images-fevicon.png">
...
<body>
							  ...
							  <div class="pbmit-header-info-inner">
								 ...
								 <div class="pbmit-header-box pbmit-header-box-2">
									<a href="#"> 
										...
										<span class="pbmit-header-box-content"><span class="__cf_email__" data-cfemail="2e47404a5b5d5a5c4b57474048416e49434f4742004d4143">[email&nbsp;protected]</span></span>
									</a> 
								 </div>
													...
													<ul class="navigation clearfix">
														...
														<li class="dropdown active">
															...
															<ul>
																...
																<li class="active"><a href="project-style-2.html">Project Style 2</a></li>
					...
					<div class="pbmit-title-bar-content-inner">
						<div class="pbmit-tbar">
							<div class="pbmit-tbar-inner container">
								<h1 class="pbmit-tbar-title">PROJECT STYLE 2</h1>
							</div>
						</div>
						<div class="pbmit-breadcrumb">
							<div class="pbmit-breadcrumb-inner">
								...
								<span><span class="post-root post post-post current-item"> PROJECT STYLE 2</span></span>
							</div>
						</div>
					</div>
				</div>
								...
								<div class="pbminfotech-post-content">
									<div class="pbmit-image-wrapper">
										<div class="pbmit-featured-wrapper">
											<img src="images/portfolio-project-01.jpg" class="img-fluid" alt="">
										</div>
									</div>
										...
										<div class="pbminfotech-box-content-wrapper">
											<div class="pbminfotech-titlebox">
												...
												<h6 class="pbmit-port-cat">
													<a href="project-single-details.html" rel="tag">Chemical</a>
												</h6>
											</div>
											<div class="pbminfotech-icon-box pbminfotech-media-link">			  	
												<a class="pbmit-lightbox" title="Chemical Industry Innovation" href="images/homepage-1/portfolio/project-01.jpg">
						...
						<div class="col-md-4">
							<article class="pbmit-portfolio-style-2">
								<div class="pbminfotech-post-content">
									<div class="pbmit-image-wrapper">
										<div class="pbmit-featured-wrapper">
											<img src="images/portfolio-project-02.jpg" class="img-fluid" alt="">
										</div>
									</div>
									<div class="pbminfotech-box-content pbminfotech-overlay">
										<div class="pbminfotech-box-content-wrapper">
											<div class="pbminfotech-titlebox">
												...
												<h6 class="pbmit-port-cat">
													<a href="project-single-details.html" rel="tag">Factory</a>
												</h6>
											</div>
											<div class="pbminfotech-icon-box pbminfotech-media-link">			  	
												<a class="pbmit-lightbox" title="Manufacture Petroleum Camber" href="images/homepage-1/portfolio/project-02.jpg">
													<i class="pbmit-base-icon-plus-symbol-button"></i>
												</a>
											</div>
										</div>
						...
						<div class="col-md-4">
							<article class="pbmit-portfolio-style-2">
								<div class="pbminfotech-post-content">
									<div class="pbmit-image-wrapper">
										<div class="pbmit-featured-wrapper">
											<img src="images/portfolio-project-03.jpg" class="img-fluid" alt="">
										</div>
									</div>
									<div class="pbminfotech-box-content pbminfotech-overlay">
										<div class="pbminfotech-box-content-wrapper">
											<div class="pbminfotech-titlebox">
												...
												<h6 class="pbmit-port-cat">
													<a href="project-single-details.html" rel="tag">Construction</a>
												</h6>
											</div>
											<div class="pbminfotech-icon-box pbminfotech-media-link">			  	
												<a class="pbmit-lightbox" title="Building Construction Project" href="images/homepage-1/portfolio/project-03.jpg">
													<i class="pbmit-base-icon-plus-symbol-button"></i>
												</a>
											</div>
										</div>
						...
						<div class="col-md-4">
							<article class="pbmit-portfolio-style-2">
								<div class="pbminfotech-post-content">
									<div class="pbmit-image-wrapper">
										<div class="pbmit-featured-wrapper">
											<img src="images/portfolio-project-04.jpg" class="img-fluid" alt="">
										</div>
									</div>
									<div class="pbminfotech-box-content pbminfotech-overlay">
										<div class="pbminfotech-box-content-wrapper">
											<div class="pbminfotech-titlebox">
												...
												<h6 class="pbmit-port-cat">
													<a href="project-single-details.html" rel="tag">Engineering</a>
												</h6>
											</div>
											<div class="pbminfotech-icon-box pbminfotech-media-link">			  	
												<a class="pbmit-lightbox" title="Boston Railway Elements" href="images/homepage-1/portfolio/project-04.jpg">
													<i class="pbmit-base-icon-plus-symbol-button"></i>
												</a>
											</div>
										</div>
						...
						<div class="col-md-4">
							<article class="pbmit-portfolio-style-2">
								<div class="pbminfotech-post-content">
									<div class="pbmit-image-wrapper">
										<div class="pbmit-featured-wrapper">
											<img src="images/portfolio-project-05.jpg" class="img-fluid" alt="">
										</div>
									</div>
									<div class="pbminfotech-box-content pbminfotech-overlay">
										<div class="pbminfotech-box-content-wrapper">
											<div class="pbminfotech-titlebox">
												...
												<h6 class="pbmit-port-cat">
													<a href="project-single-details.html" rel="tag">Manufacture</a>
												</h6>
											</div>
											<div class="pbminfotech-icon-box pbminfotech-media-link">			  	
												<a class="pbmit-lightbox" title="GC Phoenix Engineering" href="images/homepage-1/portfolio/project-05.jpg">
													<i class="pbmit-base-icon-plus-symbol-button"></i>
												</a>
											</div>
										</div>
						...
						<div class="col-md-4">
							<article class="pbmit-portfolio-style-2">
								<div class="pbminfotech-post-content">
									<div class="pbmit-image-wrapper">
										<div class="pbmit-featured-wrapper">
											<img src="images/portfolio-project-06.jpg" class="img-fluid" alt="">
										</div>
									</div>
									<div class="pbminfotech-box-content pbminfotech-overlay">
										<div class="pbminfotech-box-content-wrapper">
											<div class="pbminfotech-titlebox">
												...
												<h6 class="pbmit-port-cat">
													<a href="project-single-details.html" rel="tag">Industrial</a>
												</h6>
											</div>
											<div class="pbminfotech-icon-box pbminfotech-media-link">			  	
												<a class="pbmit-lightbox" title="Industry Logistic Solutions" href="images/homepage-1/portfolio/project-06.jpg">
													<i class="pbmit-base-icon-plus-symbol-button"></i>
												</a>
											</div>
										</div>
						...
						<div class="col-md-4">
							<article class="pbmit-portfolio-style-2">
								<div class="pbminfotech-post-content">
									<div class="pbmit-image-wrapper">
										<div class="pbmit-featured-wrapper">
											<img src="images/portfolio-project-07.jpg" class="img-fluid" alt="">
										</div>
									</div>
									<div class="pbminfotech-box-content pbminfotech-overlay">
										<div class="pbminfotech-box-content-wrapper">
											...
											<div class="pbminfotech-icon-box pbminfotech-media-link">			  	
												<a class="pbmit-lightbox" title="Construction Online Event" href="images/homepage-1/portfolio/project-07.jpg">
													<i class="pbmit-base-icon-plus-symbol-button"></i>
												</a>
											</div>
										</div>
						...
						<div class="col-md-4">
							<article class="pbmit-portfolio-style-2">
								<div class="pbminfotech-post-content">
									<div class="pbmit-image-wrapper">
										<div class="pbmit-featured-wrapper">
											<img src="images/portfolio-project-08.jpg" class="img-fluid" alt="">
										</div>
									</div>
									<div class="pbminfotech-box-content pbminfotech-overlay">
										<div class="pbminfotech-box-content-wrapper">
											...
											<div class="pbminfotech-icon-box pbminfotech-media-link">			  	
												<a class="pbmit-lightbox" title="Mineral Specialty Solutions" href="images/homepage-1/portfolio/project-08.jpg">
													<i class="pbmit-base-icon-plus-symbol-button"></i>
												</a>
											</div>
										</div>
						...
						<div class="col-md-4">
							<article class="pbmit-portfolio-style-2">
								<div class="pbminfotech-post-content">
									<div class="pbmit-image-wrapper">
										<div class="pbmit-featured-wrapper">
											<img src="images/portfolio-project-09.jpg" class="img-fluid" alt="">
										</div>
									</div>
									<div class="pbminfotech-box-content pbminfotech-overlay">
										<div class="pbminfotech-box-content-wrapper">
											...
											<div class="pbminfotech-icon-box pbminfotech-media-link">			  	
												<a class="pbmit-lightbox" title="SGA Recruitment Solutions" href="images/homepage-1/portfolio/project-09.jpg">
													<i class="pbmit-base-icon-plus-symbol-button"></i>
												</a>
											</div>
										</div>
						...
						<div class="pbmit-footer-overlay-right col-xl-9 col-md-12">
							...
							<div class="pbmit-footer-contact-info">
								<div class="pbmit-footer-contact-info-inner d-flex align-items-center">
									...
									<div class="pbmit-footer-contact-info-wrap">
										<span class="pbmit-label pbmit-label-2">E-mail Address</span><a href="email-protection.html" class="__cf_email__" data-cfemail="5831363c2d2b2c2a3d2131363e37183f35393134763b3735">[email&nbsp;protected]</a>
									</div>
								</div>
							</div>
							<div class="pbmit-footer-contact-info">
	...
	<!-- Search Box End Here -->
     ...
     <!-- JS
         ============================================ -->
      <!-- jQuery JS -->
      <script data-cfasync="false" src="js/cloudflare-static-email-decode.min.js"></script><script src="js/3107-js-jquery.min.js"></script>
      <!-- Popper JS -->
      <script src="js/7613-js-popper.min.js"></script>
      <!-- Bootstrap JS -->
      <script src="js/4991-js-bootstrap.min.js"></script> 
      <!-- jquery Waypoints JS -->
      <script src="js/6910-js-jquery.waypoints.min.js"></script>
      <!-- jquery Appear JS -->
      <script src="js/6228-js-jquery.appear.js"></script>
      <!-- Numinate JS -->
      <script src="js/6202-js-numinate.min.js"></script>
      <!-- Swiper JS -->
      <script src="js/6158-js-swiper.min.js"></script>
      <!-- Magnific JS -->
      <script src="js/3545-js-jquery.magnific-popup.min.js"></script>
      <!-- Circle Progress JS -->
      <script src="js/1228-js-circle-progress.js"></script>  
      <!-- Scripts JS -->
      <script src="js/6318-js-scripts.js"></script>       

 <script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'897493b11ad1c3a0',t:'MTcxODk3ODk3Mi4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
</html>
