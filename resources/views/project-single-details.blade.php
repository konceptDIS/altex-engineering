...
<head>
    ...
    <title>Manufacture Petroleum Camber &ndash; Industrey HTML Template</title>
    <meta name="robots" content="noindex, follow">
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="favicons/189-images-fevicon.png">
   ...
   <div class="page-wrapper">
							  ...
							  <div class="wrap">
								 <h1 class="site-title">
									<a href="index.html" rel="home">
										<span class="site-title-text">Industrey Demo1 - Industry and Engineering WordPress Theme</span>
										<img class="pbmit-main-logo" src="images/homepage-1-logo-white-dark.png" alt="Industrey Demo1" title="Industrey Demo1">
									</a>
								</h1>
							  </div>
						   </div>
							  ...
							  <div class="pbmit-header-info-inner">
								 ...
								 <div class="pbmit-header-box pbmit-header-box-2">
									<a href="#"> 
										...
										<span class="pbmit-header-box-content"><span class="__cf_email__" data-cfemail="026b6c6677717670677b6b6c646d42656f636b6e2c616d6f">[email&nbsp;protected]</span></span>
									</a> 
								 </div>
								...
								<div class="d-flex align-items-center justify-content-between header-menu-area">
									<div class="site-branding">
										<span class="site-title">
											<a href="index.html">
												<img class="pbmit-sticky-logo" src="images/homepage-1-industrey-logo.svg" alt="Industrey Demo1" title="Industrey Demo1">
											</a>
										</span>
									</div>
													...
													<ul class="navigation clearfix">
														...
														<li class="dropdown active">
															...
															<ul>
																...
																<li class="active"><a href="project-single-details.html">Project Single Details</a></li>
															</ul>
														</li>
														<li class="dropdown">
															<a href="#">Blog</a>
					...
					<div class="pbmit-title-bar-content-inner">
						...
						<div class="pbmit-breadcrumb">
							<div class="pbmit-breadcrumb-inner">
								...
								<span><a title="" href="index.html" class="home"><span>PORTFOLIO</span></a></span>
								<span class="sep"><i class="pbmit-base-icon-angle-double-right"></i></span>
								<span><span class="post-root post post-post current-item">MANUFACTURE PETROLEUM CAMBER</span></span>
							</div>
						</div>
					</div>
				</div> 
				...
				<div class="container">
					<div class="pbmit-portfolio-single">
						<div class="position-relative">
							<div class="pbmit-pf-featured-wrapper">
								<img src="images/portfolio-project-big.jpg" class="img-fluid" alt="">
							</div>
								...
								<div class="pbmit-portfolio-lines-wrapper">
									<ul class="pbmit-portfolio-lines-ul">
										<li class="pbmit-portfolio-line-li"> 
											...
											<span class="pbmit-portfolio-line-value">Envato Group, US</span>
										</li>
										<li class="pbmit-portfolio-line-li"> 
											<span class="pbmit-portfolio-line-title">Location: </span> 
											<span class="pbmit-portfolio-line-value">2946 Angus Road, NY</span>
										</li>
										<li class="pbmit-portfolio-line-li"> 
										...
										<li class="pbmit-portfolio-line-li"> 
											<span class="pbmit-portfolio-line-title">Value: </span> 
											<span class="pbmit-portfolio-line-value">$12,12,000.00</span>
										</li>
										<li class="pbmit-portfolio-line-li"> 
											<span class="pbmit-portfolio-line-title">Project Start: </span> 
											<span class="pbmit-portfolio-line-value">June 25, 2015</span>
										</li>
										<li class="pbmit-portfolio-line-li"> 
											<span class="pbmit-portfolio-line-title">Complete at: </span> 
											<span class="pbmit-portfolio-line-value">August 30, 2015</span>
										</li>
									</ul>
								</div>	
							</div>
						</div>
						<h3 class="pbmit-title">Project Description</h3>
						<p><span class="first-letter">W</span>e help our clients to build their best possible economic We understand you&rsquo;re saving for all different life events: A wonderful serenity has take possion of my entire souing like these sweet mornng spring whch enjoy the with my whole heart I am alone, and feel the charm ofexistenc in voluptate velit esse cillum fugiat nulla pariatur. excepteur sint occaecat cupidatat non proident sunt in culpa qui officia deserunt mollit anim id est laborum sed ut perspiciatis unde totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi beatae vitae dicta sunt explicabo nemo enim ipsam voluptatem sed quia consequuntur magni dolores.</p>
						<p>A wonderful serenity has take possion of my entire souing like these sweet mornng spring whch enjoy the with my whole heart I am alone, and feel the charm of existenc.the spot whch was create For then bliss of souls like mineing am so happy my dear frend. so has take possion of my entire souing like these sweet mornng spring whch enjoy the with my whole heart I am alone, and feel the charm of existenc.</p>
						<div class="row">
							<div class="col-md-4">
								<img src="images/portfolio-project-d-01.jpg" class="img-fluid" alt="">
							</div>
							<div class="col-md-4">
								<img src="images/portfolio-project-d-02.jpg" class="img-fluid img-grid" alt="">
							</div>
							<div class="col-md-4">
								<img src="images/portfolio-project-d-03.jpg" class="img-fluid" alt="">
							</div>
						</div>
						<div class="project-client">
							<h3 class="pbmit-title">What is Challenge for client?</h3>
							<p>A wonderful serenity has take possion of my entire souing like these sweet mornng spring whch enjoy the with my whole heart I am alone, and feel the charm of existenc.the spot whch was create For then bliss of souls like mineing am so happy my dear frend. so has take possion of my entire souing like these sweet mornng spring whch enjoy the with my whole heart I am alone, and feel the charm of existenc.</p>
							<div class="row">
								<div class="col-md-4">
										...
										<div class="pbmit-ihbox-box d-flex align-items-start">
											<div class="pbmit-ihbox-icon">
												<div class="pbmit-ihbox-icon-wrapper">
													<i class="pbmit-industrey-icon pbmit-industrey-icon-windmill"></i>
												</div>
											</div>
											<div class="pbmit-ihbox-contents">
												<h2 class="pbmit-element-title">Power &amp; Energy Sector</h2>
												<div class="pbmit-heading-desc">Consectetur adipiscing elit sed do tempor labor dolore magna quis</div>
											</div>
										</div>
										</div>
								</div>
								<div class="col-md-4">
									<div class="pbmit-ihbox pbmit-ihbox-style-15">
										<div class="pbmit-ihbox-box d-flex align-items-start">
											<div class="pbmit-ihbox-icon">
												<div class="pbmit-ihbox-icon-wrapper">
													<i class="pbmit-industrey-icon pbmit-industrey-icon-refinery"></i>
												</div>
											</div>
											<div class="pbmit-ihbox-contents">
												<h2 class="pbmit-element-title">Petroleum Refinery</h2>
												<div class="pbmit-heading-desc">Consectetur adipiscing elit sed do tempor labor dolore magna quis</div>
											</div>
										</div>
										</div>
								...
								<div class="col-md-4">
									<div class="pbmit-ihbox pbmit-ihbox-style-15">
										<div class="pbmit-ihbox-box d-flex align-items-start">
											<div class="pbmit-ihbox-icon">
												<div class="pbmit-ihbox-icon-wrapper">
													<i class="pbmit-industrey-icon pbmit-industrey-icon-conveyor"></i>
												</div>
											</div>
											<div class="pbmit-ihbox-contents">
												<h2 class="pbmit-element-title">Mechanical Engineering</h2>
												<div class="pbmit-heading-desc">Consectetur adipiscing elit sed do tempor labor dolore magna quis</div>
											</div>
										</div>
										</div>
						...
						<div>
							<h3 class="pbmit-title">Providing solutions from start to the end</h3>
							<p class="mb-0">A wonderful serenity has take possion of my entire souing like these sweet mornng spring whch enjoy the with my whole heart I am alone, and feel the charm of existenc.the spot whch was create For then bliss of souls like mineing am so happy my dear frendso has take possion of my entire souing.</p>
							<div class="row">
								<div class="col-md-6">
									<ul class="list-group list-group-borderless">
										<li class="list-group-item">Dedicated to Save Lives exclusive essential cancel project</li>
										<li class="list-group-item">Override the digital divide with additional activity to beta</li>
										<li class="list-group-item">Enable accurate supply chains rather than frictionless technology</li>
										</ul>
								</div>
								<div class="col-md-6">
									<ul class="list-group list-group-borderless">
						...
						<div class="nav-previous">
							<a href="#" rel="prev">
								<span class="pbmit-portfolio-nav-thumbnail">
									<img src="images/portfolio-project-01s.jpg" class="img-fluid" alt="">
									<span class="pbmit-portfolio-nav-icon">
										<i class=" pbmit-base-icon-arrow-left-solid"></i>
									</span> 
								</span> 
								<span class="pbmit-portfolio-nav-wrapper">
									<span class="pbmit-portfolio-nav-head">Previous</span>
									<span class="pbmit-portfolio-nav nav-title">Building Construction Project</span> 
								</span>
							</a>
						</div>
						<div class="nav-next">
							<a href="#" rel="next">
								<span class="pbmit-portfolio-nav-wrapper">
									...
									<span class="pbmit-portfolio-nav nav-title">Chemical Industry Innovation</span> 
								</span> 
								<span class="pbmit-portfolio-nav-thumbnail"> 
									<span class="pbmit-portfolio-nav-icon">
										<i class=" pbmit-base-icon-arrow-right-solid"></i>
									</span>
									<img src="images/portfolio-project-02s.jpg" class="img-fluid" alt="">
								</span>
							</a>
						</div>
					</div>
						...
						<div class="pbmit-footer-overlay-right col-xl-9 col-md-12">
							...
							<div class="pbmit-footer-contact-info">
								<div class="pbmit-footer-contact-info-inner d-flex align-items-center">
									...
									<div class="pbmit-footer-contact-info-wrap">
										<span class="pbmit-label pbmit-label-2">E-mail Address</span><a href="email-protection.html" class="__cf_email__" data-cfemail="deb7b0baabadaaacbba7b7b0b8b19eb9b3bfb7b2f0bdb1b3">[email&nbsp;protected]</a>
									</div>
								</div>
							</div>
							<div class="pbmit-footer-contact-info">
	...
	<div class="pbmit-search-overlay">
     ...
     <!-- JS
         ============================================ -->
      <!-- jQuery JS -->
      <script data-cfasync="false" src="js/cloudflare-static-email-decode.min.js"></script><script src="js/214-js-jquery.min.js"></script>
      <!-- Popper JS -->
      <script src="js/2012-js-popper.min.js"></script>
      <!-- Bootstrap JS -->
      <script src="js/4965-js-bootstrap.min.js"></script> 
      <!-- jquery Waypoints JS -->
      <script src="js/5140-js-jquery.waypoints.min.js"></script>
      <!-- jquery Appear JS -->
      <script src="js/9020-js-jquery.appear.js"></script>
      <!-- Numinate JS -->
      <script src="js/4088-js-numinate.min.js"></script>
      <!-- Swiper JS -->
      <script src="js/8407-js-swiper.min.js"></script>
      <!-- Magnific JS -->
      <script src="js/2359-js-jquery.magnific-popup.min.js"></script>
      <!-- Circle Progress JS -->
      <script src="js/5562-js-circle-progress.js"></script>  
      <!-- Scripts JS -->
      <script src="js/1023-js-scripts.js"></script>     

<script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'897493dc7c06eb3f',t:'MTcxODk3ODk3OS4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
</html>
