...
<head>
    ...
    <title>Norton Berry &ndash; Industrey HTML Template</title>
    <meta name="robots" content="noindex, follow">
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="favicons/9599-images-fevicon.png">
   ...
   <div class="page-wrapper">
							  ...
							  <div class="pbmit-header-info-inner">
								 ...
								 <div class="pbmit-header-box pbmit-header-box-2">
									<a href="#"> 
										...
										<span class="pbmit-header-box-content"><span class="__cf_email__" data-cfemail="5e37303a2b2d2a2c3b27373038311e39333f3732703d3133">[email&nbsp;protected]</span></span>
									</a> 
								 </div>
					...
					<div class="pbmit-title-bar-content-inner">
						...
						<div class="pbmit-breadcrumb">
							<div class="pbmit-breadcrumb-inner">
								<span><a title="" href="#" class="home"><span>INDUSTREY</span></a></span>
								<span class="sep"><i class="pbmit-base-icon-angle-double-right"></i></span>
								<span><span class="post-root post post-post">OUR TEAM MEMBER</span></span>
								<span class="sep"><i class="pbmit-base-icon-angle-double-right"></i></span>
								<span><span class="post-root post post-post current-item">NORTON BERRY</span></span>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="pbmit-team-single-info">
							<div class="row align-items-center">
								<div class="col-md-12 col-lg-6">
									<div class="pbmit-team-left-inner">
										<div class="pbmit-team-download">
											<a href="#">Download vcard</a>
										</div>
										<div class="pbmit-featured-wrapper">
											<img src="images/team-demo-new-01.jpg" class="img-fluid" alt="">
										</div>
									</div>
								</div>
								<div class="col-md-12 col-lg-6">
									<div class="pbmit-team-des">
										<div class="pbmit-team-des-wrap d-flex justify-content-between">
											<div class="pbmit-team-summary">
												<h2 class="pbmit-team-title">Norton Berry</h2>
												<h4 class="pbmit-team-designation">Senior Advisor</h4>
											</div>
										...
										<ul class="pbmit-single-team-info">
											<li>
												<label>Phone</label> 123456789
											</li>
											<li>
												<label>Email</label> 
												<a href="/cdn-cgi/l/email-protection#f79e999198b7839f929a928483929cd994989a"><span class="__cf_email__" data-cfemail="244d4a424b64504c4149415750414f0a474b49">[email&nbsp;protected]</span></a>
											</li>
											<li>
												<label>Website</label> 
												<a href="http://www.themestek.com">www.themestek.com</a> 
											</li>
											<li>
												<label>Fax</label> 123456789
											</li>
										</ul>
									</div>
								</div>
						 ...
						 <div class="col-md-12">
							<div class="team-details-wrap">
								<h3 class="pbmit-title">Biography</h3>
								<p>Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, aliquam quaerat voluptatem Neque porro quisquam est, qui dolorem ipsum quia dolor sit who remains single point of contact throughout the project. And, we have a squad of designers, developers, copy writers, and quality analysts. With whom you will work, it totally depends on your project requirements service to our customers our business growth &amp; marketing.</p>
								<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, aliquam quaerat voluptatem Neque porro quisquam est, qui dolorem ipsum quia dolor sit who remains single point of contact throughout the project.</p>
								<div class="row">
									<div class="col-xl-5 col-md-12">
										<div class="team-progress">
											<h3 class="pbmit-title">Skills</h3>
											<div class="progressbar progressbar-style-1">
												<span class="progress-label">Quality Control System</span>
												<div class="progress progress-lg progress-percent-bg">
													<div class="progress-bar aos aos-init aos-animate" data-aos="slide-right" data-aos-delay="200" data-aos-duration="1000" data-aos-easing="ease-in-out" role="progressbar" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100" style="width:65%">
													</div>
													<span class="progress-percent">65%</span>
												</div>
											</div>
											<div class="progressbar progressbar-style-1">
												<span class="progress-label">Products development</span>
												<div class="progress progress-lg progress-percent-bg">
											...
											<div class="progressbar progressbar-style-1">
												<span class="progress-label">Customers Satisfaction</span>
												<div class="progress progress-lg progress-percent-bg">
													<div class="progress-bar aos aos-init aos-animate" data-aos="slide-right" data-aos-delay="200" data-aos-duration="1000" data-aos-easing="ease-in-out" role="progressbar" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100" style="width:85%">
													</div>
									...
									<div class="col-xl-7 col-md-12">
										<div class="team-single">
											<h3 class="pbmit-title">Work Experience</h3>
											<div class="pbmit-ihbox pbmit-ihbox-style-12">
												<div class="pbmit-ihbox-box">
													<div class="pbmit-ihbox-icon">
														<div class="pbmit-ihbox-icon-wrapper"></div>
													</div>
													<div class="pbmit-ihbox-contents">
														<h2 class="pbmit-element-title">2015-Famous</h2>
														<div class="pbmit-heading-desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit sed do eiusmod tempor incididunt ut labore et dolore.</div>
													</div>
												</div>
											</div>
											<div class="pbmit-ihbox pbmit-ihbox-style-12">
												<div class="pbmit-ihbox-box">
													...
													<div class="pbmit-ihbox-contents">
														<h2 class="pbmit-element-title">2012-Evolved
														</h2>
														<div class="pbmit-heading-desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit sed do eiusmod tempor incididunt ut labore et dolore.</div>
													</div>
												</div>
											...
											<div class="pbmit-ihbox pbmit-ihbox-style-12">
												<div class="pbmit-ihbox-box">
													...
													<div class="pbmit-ihbox-contents">
														<h2 class="pbmit-element-title">2008-Startup</h2>
														<div class="pbmit-heading-desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit sed do eiusmod tempor incididunt ut labore et dolore.</div>
													</div>
												</div>
											</div>
								...
								<div class="team-contact">
									<h2 class="pbmit-title">Contact Me</h2>
									<form class="team-details-contact">
										<div class="row gx-1 pt-0">
											<div class="col-md-6 col-lg-6">
												<input type="text" class="form-control mb-0" placeholder="Your Name *" name="Your Name *">
											</div>
											<div class="col-md-6 col-lg-6">
											...
											<div class="col-md-4">
												<button href="contact-us.html" class="pbmit-btn pbmit-btn-shape-round w-100 mt-4">
						...
						<div class="pbmit-footer-overlay-right col-xl-9 col-md-12">
							...
							<div class="pbmit-footer-contact-info">
								<div class="pbmit-footer-contact-info-inner d-flex align-items-center">
									...
									<div class="pbmit-footer-contact-info-wrap">
										<span class="pbmit-label pbmit-label-2">E-mail Address</span><a href="email-protection.html" class="__cf_email__" data-cfemail="761f181203050204130f1f18101936111b171f1a5815191b">[email&nbsp;protected]</a>
									</div>
								</div>
							</div>
							<div class="pbmit-footer-contact-info">
	...
	<!-- Search Box End Here -->
     ...
     <!-- JS
         ============================================ -->
      <!-- jQuery JS -->
      <script data-cfasync="false" src="js/cloudflare-static-email-decode.min.js"></script><script src="js/8552-js-jquery.min.js"></script>
      <!-- Popper JS -->
      <script src="js/6112-js-popper.min.js"></script>
      <!-- Bootstrap JS -->
      <script src="js/6954-js-bootstrap.min.js"></script> 
      <!-- jquery Waypoints JS -->
      <script src="js/5534-js-jquery.waypoints.min.js"></script>
      <!-- jquery Appear JS -->
      <script src="js/5947-js-jquery.appear.js"></script>
      <!-- Numinate JS -->
      <script src="js/2204-js-numinate.min.js"></script>
      <!-- Swiper JS -->
      <script src="js/8496-js-swiper.min.js"></script>
      <!-- Magnific JS -->
      <script src="js/6070-js-jquery.magnific-popup.min.js"></script>
      <!-- Circle Progress JS -->
      <script src="js/8121-js-circle-progress.js"></script>  
      <!-- Scripts JS -->
      <script src="js/3312-js-scripts.js"></script>    

<script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'8974935f5f2d3089',t:'MTcxODk3ODk1OS4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body></html>
